 ...
 */
public class TypedSubtraction extends TypedExpression {
     ...
     */
    public TypedSubtraction(String filename, int lineNumber, IdSymbol type, TypedExpression a1, TypedExpression a2) {
    ...
    public boolean equals(Object obj) {
        ...
        TypedSubtraction other = (TypedSubtraction) obj;
        if (e1 == null) {
            if (other.e1 != null) {
                return false;
            }
