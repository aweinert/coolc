...
class ParentDefinednessChecker {
     ...
     * Object
     */
    public static ParsedProgram checkParentDefinedness(ParsedProgram program, SemanticErrorReporter err) {
        ...
        for (ClassNode classNode : program.getClasses()) {
            ...
            if (!parentDefined && !inheritsFromObject) {
                ...
                returnProgram = returnProgram.replaceClass(classNode, classNode.setParent(objectId));
            }
        }
